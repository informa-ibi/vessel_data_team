...
from src.setup import CHARACTERISTIC, CONFLICTS_MANUAL_UPDATE, IMAGES, OUTPUT_DIR
...
if __name__ == '__main__':
    ...
    df.to_csv(OUTPUT_DIR / f'{CHARACTERISTIC}' / f'count_manual_update_by_feed_month_to_resolve_{int(YEAR)}.csv', index=False)
